...
* The dependencies file must be a link to a txt where the txt has all of the links to the dependencies of your library and the links of their deps.txt. **Do not make this dependencies file have the names of the dependencies or any other metadata.** (see exampledeps.md for more details)
...
* You must use all columns but if you do not have any dependencies which aren't from the standard lib, just put "__NONE" as the entry. **Do not include any standard library headers in your deps file**
