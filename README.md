...
* The dependencies file must be a link to a txt where the txt has all of the links to the dependencies of your library. **Do not make this dependencies file have the names of the dependencies or any other metadata.**
...
* You must use all columns except for the "dependencies file" column, but you do not neccessarily need an entry for the dependencies file. **Do not include any standard library headers in your deps file"**
