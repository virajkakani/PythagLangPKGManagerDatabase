...
* The dependencies file must be a link to a txt where the txt has all of the links to the dependencies of your library and the links of their deps.txt. **Do not make this dependencies file have the names of the dependencies or any other metadata.**
