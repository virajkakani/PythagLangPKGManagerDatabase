...
* You must use all columns but if you do not have any dependencies which aren't from the standard lib, just put "__NONE". **Do not include any standard library headers in your deps file**
