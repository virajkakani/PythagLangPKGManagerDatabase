...
* The dependencies file must be a link to a txt where the txt has all of the **links** to the dependencies of your library
* No entry may be named "name", "version", "links
